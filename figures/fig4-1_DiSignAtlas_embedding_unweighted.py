...
if __name__ == "__main__":
    ...
    os.makedirs(f"../data/fig4/{config.exp}_{disease_name}_unweighted_graph", exist_ok=True)
    ...
    np.save(f"../data/fig4/{config.exp}_{disease_name}_unweighted_graph/gene_vec_{config.embedding_dim}.npy", encoded_genes)
    np.save(f"../data/fig4/{config.exp}_{disease_name}_unweighted_graph/gene_ids.npy", gene_ids)